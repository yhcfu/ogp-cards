...
<style>
*{box-sizing:border-box}body{margin:0}.card{display:flex;width:640px;height:160px;border:0;border-radius:18px;overflow:hidden;background:#151b24;color:#e6edf6;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","Noto Sans",sans-serif;-webkit-font-smoothing:antialiased}.media{flex:0 0 160px;width:160px;height:160px;background:#202936;border-right:0;display:flex;align-items:center;justify-content:center}.media img{width:100%;height:100%;object-fit:cover;display:block}.placeholder{width:34px;height:34px;color:#7f90a8}.content{min-width:0;flex:1;padding:15px 17px;display:flex;flex-direction:column;justify-content:center;gap:4px}.site{font-size:16px;line-height:20px;color:#a0adbf;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.title{font-size:18px;line-height:23px;font-weight:500;color:#e6edf6}.description{font-size:16px;line-height:21px;color:#a0adbf}.title,.description{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;overflow-wrap:anywhere}
</style>
